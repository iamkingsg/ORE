echo "Showing MaransCrypto logo..."
wget -O loader.sh https://github.com/gowthamaran/Maranscrypto-Guides/blob/main/loader.sh && chmod +x loader.sh && ./loader.sh
curl -s https://github.com/gowthamaran/Maranscrypto-Guides/blob/main/loader.sh | bash
sleep 2
...
echo "Subscribe: https://t.me/Maranscrypto"
